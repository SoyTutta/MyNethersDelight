...
public class MNDCraftingRecipes {
    ...
    private static void recipesBlocks(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(MNDBlocks.BLOCK_OF_POWDERY_CANNON.get())
                .pattern("###")
                .pattern("###")
                .pattern("###")
                .define('#', MNDTags.POWDER_CANNON)
        ...
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_CABINET.get())
                .pattern("#X#")
                .pattern("# #")
                .pattern("#X#")
        ...
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_MOSAIC.get())
                .pattern("#")
                .pattern("#")
        ...
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_MOSAIC_SLAB.get(),6)
                .pattern("###")
                .define('#', MNDItems.POWDERY_MOSAIC.get())
                .group("wooden_slab")
                .unlockedBy("has_powdery_mosaic", InventoryChangeTrigger.TriggerInstance.hasItems(MNDItems.POWDERY_PLANKS.get()))
                .save(consumer, new ResourceLocation("mynethersdelight", "powdery_mosaic_slab"));
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_MOSAIC_STAIRS.get(),4)
                .pattern("#  ")
                .pattern("## ")
                .pattern("###")
                .define('#', MNDItems.POWDERY_PLANKS.get())
        ...
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_DOOR.get(),3)
                .pattern("##")
                .pattern("##")
                .pattern("##")
                .define('#', MNDItems.POWDERY_PLANKS.get())
        ...
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_TRAPDOOR.get(),2)
                .pattern("###")
                .pattern("###")
                .define('#', MNDItems.POWDERY_PLANKS.get())
        ...
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_FENCE.get(),3)
                .pattern("#X#")
                .pattern("#X#")
                .define('#', MNDItems.POWDERY_PLANKS.get()).define('X', Items.STICK)
                .group("wooden_fence")
        ...
        ShapedRecipeBuilder.shaped(MNDBlocks.POWDERY_FENCE_GATE.get())
                .pattern("X#X")
                .pattern("X#X")
                .define('#', MNDItems.POWDERY_PLANKS.get()).define('X', Items.STICK)
