...
public class MNDBlockTags extends BlockTagsProvider {
    ...
    protected void registerModTags() {
        ...
        this.tag(ModTags.Blocks.TRAY_HEAT_SOURCES).add(MNDBlocks.MAGMA_CAKE.get(), MNDBlocks.BLAZIER_BLOCK.get());
        ...
        this.tag(ModTags.Blocks.FEASTS).add(MNDBlocks.STUFFED_HOGLIN.get(), MNDBlocks.STRIDERLOAF_BLOCK.get(),
                MNDBlocks.GHASTA_WITH_CREAM_BLOCK.get(), MNDBlocks.MAGMA_CAKE.get(), MNDBlocks.BREAD_LOAF_BLOCK.get());
