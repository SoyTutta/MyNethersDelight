...
public class MNDBlockTags extends BlockTagsProvider {
    public MNDBlockTags(DataGenerator generatorIn, String modId, @Nullable ExistingFileHelper existingFileHelper) {
    ...
    protected void registerBlockMineables() {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(MNDBlocks.NETHER_BRICKS_CABINET.get(),MNDBlocks.NETHER_STOVE.get(),MNDBlocks.BLOCK_OF_POWDERY_CANNON.get(),MNDBlocks.BLOCK_OF_STRIPPED_POWDERY_CANNON.get(),MNDBlocks.POWDERY_PLANKS.get(),MNDBlocks.POWDERY_PLANKS_SLAB.get(),MNDBlocks.POWDERY_PLANKS_STAIRS.get(),MNDBlocks.POWDERY_MOSAIC.get(),MNDBlocks.POWDERY_MOSAIC_STAIRS.get(),MNDBlocks.POWDERY_MOSAIC_SLAB.get(),MNDBlocks.POWDERY_FENCE.get(),MNDBlocks.POWDERY_FENCE_GATE.get(),MNDBlocks.POWDERY_TRAPDOOR.get(),MNDBlocks.POWDERY_DOOR.get(),MNDBlocks.POWDERY_BUTTON.get(),MNDBlocks.POWDERY_PRESSURE_PLATE.get(),MNDBlocks.POWDERY_WALL_SIGN.get(),MNDBlocks.POWDERY_SIGN.get(),MNDBlocks.POWDERY_CABINET.get());
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(MNDBlocks.HOGLIN_TROPHY.get(),MNDBlocks.WAXED_HOGLIN_TROPHY.get(),MNDBlocks.ZOGLIN_TROPHY.get(),MNDBlocks.POWDERY_CANNON.get(),MNDBlocks.POWDERY_CANE.get(),MNDBlocks.POWDERY_CHUBBY_SAPLING.get(),MNDBlocks.BULLET_PEPPER.get());
