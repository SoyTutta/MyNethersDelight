...
public class PoachingFailureCase {
    ...
    public PoachingFailureCase(EntityType<? extends Mob> sourceType, EntityType<? extends Mob> targetType,
                               SoundEvent transformSound, BiPredicate<Mob, ItemStack> condition,
                               BiConsumer<Mob, Mob> setupAction) {
    ...
    public boolean matches(Mob mob, ItemStack weapon) {
        return mob.getType() == sourceType && condition.test(mob, weapon);
    }

    public EntityType<? extends Mob> getTargetType() {
        return targetType;
    }
    ...
    public BiConsumer<Mob, Mob> getSetupAction() {
        return setupAction;
    }
}
