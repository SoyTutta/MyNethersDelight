...
public class MNDBiomeFeatures {
    ...
    public static final Supplier<Feature<PowderyCaneConfiguration>> POWDERYCANE = FEATURES.register("powderycane", () -> new PowderyCaneFeature(PowderyCaneConfiguration.CODEC));
}
