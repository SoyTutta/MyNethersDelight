...
public class EatMagmaCakeGoal extends Goal {
    ...
    public void tick() {
        ...
        } else if (this.targetPos instanceof Entity entity) {
    ...
    private void updateTarget() {
        ...
        if (cakePos != null) {
            minDistanceSq = frogPos.distSqr(cakePos);
    ...
    private void moveToTarget() {
        if (targetPos instanceof BlockPos pos) {
            this.frog.getNavigation().moveTo(pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5, 1.5);
        } else if (targetPos instanceof Entity entity) {
