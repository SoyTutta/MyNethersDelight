...
public class MNDItemsMD {
    ...
    static {
        STRIDER_STEW_CUP = ITEMS.register("strider_stew_cup", ()  ->
                new CopperCupFoodItem(CupFoodItem(MNDFoodValues.STRIDER_STEW_CUP))
        );
        SPICY_NOODLE_SOUP_CUP = ITEMS.register("spicy_noodle_soup_cup", ()  ->
                new CopperCupFoodItem(CupFoodItem(MNDFoodValues.SPICY_NOODLE_SOUP_CUP))
        );
        SPICY_HOGLIN_STEW_CUP = ITEMS.register("spicy_hoglin_stew_cup", ()  ->
                new CopperCupFoodItem(CupFoodItem(MNDFoodValues.SPICY_HOGLIN_STEW_CUP))
        );
        ROCK_SOUP_CUP = ITEMS.register("rock_soup_cup", ()  ->
                new CopperCupFoodItem(CupFoodItem(MNDFoodValues.ROCK_SOUP_CUP))
        );
        EGG_SOUP_CUP = ITEMS.register("egg_soup_cup", ()  ->
                new CopperCupFoodItem(CupFoodItem(MNDFoodValues.EGG_SOUP_CUP))
        );
    }
}
