...
public class JEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addIngredientInfo(List.of( new ItemStack(MNDItems.STRIDERLOAF_BLOCK.get()), new ItemStack(MNDItems.STRIDERLOAF.get()), new ItemStack(MNDItems.COLD_STRIDERLOAF_BLOCK.get()), new ItemStack(MNDItems.COLD_STRIDERLOAF.get())), VanillaTypes.ITEM_STACK, MNDTextUtils.getTranslation("jei.info.plate_of_striderloaf"));
    }
